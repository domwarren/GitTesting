...
$about_page_image->set_size(940, 199);
$about_page_image->set_description('Recommended size: 940x200');
...
function not_singular_content() {
	...
	?>
	<?php if ( have_posts() ):  ?>
	<?php if ( !is_paged() ): the_post(); ?>		<h3 style="margin-top: 12px">News and Knowledge</h3>		
...
function top_blog_section() {
	if (is_home() || is_single()) {
		$title = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Knowledge Centre...prepare for your dream job';
	} elseif(is_archive()) {
		$title = 'Archive';
	} elseif(is_search()) {
		$title = 'Search Results';
	...
	<!--	<div id="top-text-section">
		<div class="doubleborder">
			<h2 class="cufon-plain left"><span><?php echo $title; ?></span></h2>		
			<a href="#" class="subscribers right">Subscribe to<br/>our feed
