					...
					<?php else: //If it is a single portfolio item ?>		
						<div class="default-page">
							...
							<?php 
								...
								<div class="image">
									<a href="<?php echo get_upload_url() . '/' . get_post_meta($post->ID, '_portfolio_image', 1); ?>" rel="fancybox"><img src="<?php echo get_upload_url() . '/' . get_post_meta($post->ID, '_portfolio_image_medium', 1); ?>" alt="" /></a>
								</div>								
							<?php endif ?>
							<div class="entry">
								<?php the_content(); ?>
