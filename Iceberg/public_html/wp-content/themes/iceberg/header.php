...
<head>
	...
	<link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/color-schemes/<?php echo get_option('color_scheme'); ?>/style.css?v=2" type="text/css" media="all" />
	<link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/fancybox/jquery.fancybox-1.3.0.css" type="text/css" media="screen" />		<link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/slider.css" type="text/css" media="screen" />
					...
					<div id="header">
						<div id="branding">
							...
							<h1 id="logo" <?php echo (!$use_logo) ? 'class="text-logo cufon-plain"' : ''; ?>>
								<a href="<?php echo get_option('home'); ?>" style="background: <?php echo ($use_logo) ? 'url(' . $logo_img . '?v=1)' : 'transparent'; ?> no-repeat 0 0;"><?php bloginfo('title'); ?></a>
							</h1>
														<div class="header-contact">								<span class="phone-icon-link">02 8246 9030</span>								<span class="email-icon-link"><a href="mailto:info@icebergrecruit.com.au">info@icebergrecruit.com.au</a></span>							</div>							<?php if ( get_option('enable_intro_text') != 'n' ): ?>								<h2 id="slogan" class="cufon-default"><?php echo f_get_tagline(); ?></h2>								<?php endif ?>								
						</div>
						<div id="nav-section">
