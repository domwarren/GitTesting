...
$homepage_options = new OptionsPage(array(
	...
	wp_option::factory('image','homepage_area_1_bullet', 'Area 1 bullet')->help_text('Recommended Size: 272x103'),
	...
	wp_option::factory('image', 'homepage_area_2_bullet', 'Area 2 bullet')->help_text('Recommended Size: 272x103'),
	...
	wp_option::factory('image', 'homepage_area_3_bullet', 'Area 3 bullet')->help_text('Recommended Size: 272x103'),
		...
		function change_box_count() {
			switch($(".field-homepage_areas_count select").val()) {
				case "1":
					...
					$(".field-homepage_area_2_bullet, .field-homepage_area_2, .field-homepage_area_3, .field-homepage_area_3_bullet").show();
				break;
				case "2":
					$(".field-homepage_area_1_bullet, .field-homepage_area_1_bullet, .field-homepage_area_2, .field-homepage_area_2_bullet").show();
					$(".field-homepage_area_3, .field-homepage_area_3_bullet").show();
				break;
				case "3":
