...
{	
	...
	function displayOptionsPage()
	{
      ...
      <input type="hidden" name="page_options" value="fqr_title,fqr_delay,fqr_fade,fqr_fadeout,fqr_random,fqr_stylesheet" />
	...
	function displayWidgetControl()
	{
		...
		echo '<p style="text-align:right;"><label for="quoterotator-title">Title: <input style="width: 200px;" id="quoterotator-title" name="quoterotator-title" type="text" value="'.$title.'" /></label></p>';
		echo '<p style="text-align:right;"><label for="quoterotator-delay">Delay(seconds): <input style="width: 200px;" id="quoterotator-delay" name="quoterotator-delay" type="text" value="'.$delay.'" /></label></p>';
		echo '<p style="text-align:right;"><label for="quoterotator-fade">Fade Time(seconds): <input style="width: 200px;" id="quoterotator-fade" name="quoterotator-fade" type="text" value="'.$fade.'" /></label></p>';
		echo '<p style="text-align:right;"><label for="quoterotator-fontsize">Font Size(pixels): <input style="width: 150px;" id="quoterotator-fontsize" name="quoterotator-fontsize" type="text" value="'.$fontsize.'" /></label>';
		...
		echo '</select>';
		echo '</label></p>';
		echo '<p style="text-align:right;"><label for="quoterotator-random">Random?: <input id="quoterotator-random1" name="quoterotator-random" type="radio" ';
		if($random==1)
			echo 'checked="yes" ';
		echo 'value="1" /> Yes';
