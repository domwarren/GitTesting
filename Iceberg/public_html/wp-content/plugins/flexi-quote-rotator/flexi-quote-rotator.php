...
Version: 0.2
Author: Aidan Curran, Luke Howell
Author URI: http://sww.co.nz/
Original Plugin URI: http://www.lukehowell.com/wordpress/quote-rotator/
...
if( isset($quoteRotator) && isset($management) )
{
	...
	function widgetInit()
	{
		...
		register_sidebar_widget('Quote', array(&$quoteRotator, 'displayWidget'));
		register_widget_control('Quote', array(&$management, 'displayWidgetControl'), 375, 200);
	}
